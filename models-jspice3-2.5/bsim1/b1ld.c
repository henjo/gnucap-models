...
line755:
            ...
            /* old 3e2
            if( here->B1mode > 0 ) {
                B1mosCap(ckt,vgd,vgs,vgb,GateDrainOverlapCap,
                ...
                B1mosCap(ckt,vgs,vgd,vgb,GateSourceOverlapCap,
            ...
            *(ckt->CKTstate0 + here->B1qb) = qbulk +  
            ...
            NI_INTEG(ckt,geq,ceq,0.0,here->B1qb);
            NI_INTEG(ckt,geq,ceq,0.0,here->B1qg);
            NI_INTEG(ckt,geq,ceq,0.0,here->B1qd);
