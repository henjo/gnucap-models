...
struct dvec {
    ...
    struct dvlist *v_link2; /* Extra link for things like print. */
...
struct plot {
    ...
    void *pl_hashtab;       /* Hash head for permanent vectors */
    ...
    int pl_active;          /* Nonzero when the plot is being used */
