...
/* device questions */
/* in UCB distr, these are 300's (error) */
#define JFET_DRAINNODE        201
#define JFET_GATENODE         202
#define JFET_SOURCENODE       203
#define JFET_DRAINPRIMENODE   204
#define JFET_SOURCEPRIMENODE  205
#define JFET_VGS              206
#define JFET_VGD              207
#define JFET_CG               208
#define JFET_CD               209
...
#define JFET_GGD              214
#define JFET_QGS              215
#define JFET_CQGS             216
#define JFET_QGD              217
#define JFET_CQGD             218
#define JFET_CS               219
#define JFET_POWER            220
...
extern int  JFETnoise(int,int,GENmodel*,CKTcircuit*,GENERIC*,double*);
extern int  JFETparam(CKTcircuit*,int,IFvalue*,GENinstance*,IFvalue*);
extern void JFETparse(int,GENERIC*,GENERIC*,GENERIC*);
