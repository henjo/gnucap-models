 ...
 * using the BSIM2 (Berkeley Short-Channel IGFET Model) Equations.
 */
void
B2evaluate(Vds,Vbs,Vgs,here,model,gm,gds,gmb,qg,qb,qd,cgg,cgd,cgs,
    ...
    double *cbd,*cbs,*cdg,*cdd,*cds,*Ids,*von,*vdsat;
 {
    ...
    double dUvert_dVg, dUvert_dVd, dUvert_dVb, dBeta0_dVd, dBeta0_dVb, Inv_Kk;
    ...
    double T6, T7, T8, T9, Usat, n, ExpArg, ExpArg1;
