...
#define info	 B3v0info
#define INSTANCE BSIM3v0instance
#define MODEL	 BSIM3v0model

#define SPICE_LETTER "M"
#define DEVICE_TYPE "ngspice_bsim3v0|ngspice_bsim3"
#define MIN_NET_NODES 4
#define MAX_NET_NODES 4
#define INTERNAL_NODES 3
#define MODEL_TYPE "nmos8|pmos8|nmos52|pmos52|nmos49|pmos49"
