...
#define info	 BSIM3v1Sinfo
#define INSTANCE BSIM3v1Sinstance
#define MODEL	 BSIM3v1Smodel

#define SPICE_LETTER "M"
#define DEVICE_TYPE "ngspice_bsim3v1s|ngspice_bsim3"
#define MIN_NET_NODES 4
#define MAX_NET_NODES 4
#define INTERNAL_NODES 3
#define MODEL_TYPE "nmos8|pmos8|nmos49|pmos49"
